...
sint check_ft_type(char* ft_type, char* ft_name, sint* type)
{
    ...
    if (strcmp(ft_type, "STRUCT") == 0) {
        ...
        (*type) = STRUCT;
        ret = 1;
    } else if ((strcmp(ft_type, "HELIX") == 0) || (strcmp(ft_type, "STRAND") == 0)) {
        strcpy(ft_name, ft_type);
        strcpy(ft_type, "STRUCT");
        seq_type = 3;
        (*type) = STRUCT;
        ret = 1;
    } else if ((strcmp(ft_type, "DNA_BIND") == 0) || (strcmp(ft_type, "ZN_FING") == 0)) {
        strcpy(ft_name, ft_type);
        strcpy(ft_type, "DOMAIN");
        (*type) = SWDOMAIN;
        ret = 1;
    } else if ((strcmp(ft_type, "NP_BIND") == 0) || (strcmp(ft_type, "CA_BIND") == 0) || (strcmp(ft_type, "METAL") == 0) || (strcmp(ft_type, "CARBOHYD") == 0) || (strcmp(ft_type, "DISULFID") == 0) || (strcmp(ft_type, "SITE") == 0) || (strcmp(ft_type, "ACT_SITE") == 0) || (strcmp(ft_type, "BINDING") == 0)) {
        strcpy(ft_name, ft_type);
        strcpy(ft_type, "SITE");
        (*type) = SITE;
        ret = 1;
