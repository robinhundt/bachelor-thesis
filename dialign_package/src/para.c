...
void para_read(int num, char** arg)
{
    ...
    while (an < num - 1) {
        if (strcmp(arg[an], "-afc") && /* create file containing
            ...
            strcmp(arg[an], "-ds") && strcmp(arg[an], "-fa") && /* separate file with
            ...
            strcmp(arg[an],
                "-lgsx")
            && /* genomic sequences, accurate + textual alignment */
            ...
            strcmp(arg[an], "-mask") && strcmp(arg[an], "-mat") && /* calc. subst. freq. matrix */
            ...
            strcmp(arg[an], "-smin") && strcmp(arg[an], "-stdo") && /* standard output */
...
*/
        ...
        if (!strcmp(arg[an], "-mot"))
            if ((an + 4 < num) && num_test(arg[an + 2]) && num_test(arg[an + 3])) {
                motifs = 1;
