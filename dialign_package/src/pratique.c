...
void**
callouer_mat(size_t t_elt, size_t nb_lig, size_t nb_col)
{
    void** pointeur;
    int i;
...
void**
recallouer_mat(void** pointeur, size_t t_elt, size_t anc_nb_lig, size_t nb_lig,
    size_t nb_col)
{
    int i;
...
void**
recallouer_mat2(void** pointeur, size_t t_elt, size_t anc_nb_lig, size_t nb_lig,
    size_t nb_col)
{
    int i;
    for (i = nb_lig; i < anc_nb_lig; i++)
